...
router.put('/:studentId', validate(updateSchema), (req, res, next) => controller.update(req, res, next));
router.put('/:studentId/device', validate(deviceSchema), (req, res, next) => controller.updateDevice(req, res, next));
