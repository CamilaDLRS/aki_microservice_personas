...
interface ClassAttributes { id: number; name: string; created_at?: Date; updated_at?: Date; }
...
export class ClassModel extends Model<ClassAttributes, ClassCreationAttributes> implements ClassAttributes {
  public id!: number; public name!: string; public created_at!: Date; public updated_at!: Date;
}
