...
export async function initSequelize() {
  ...
  sequelize = new Sequelize(process.env.DB_NAME || 'personas_db', process.env.DB_USER || 'sa', process.env.DB_PASSWORD || '', {
  ...
  ClassModel.belongsToMany(StudentModel, { through: ClassStudentModel, foreignKey: 'class_id', otherKey: 'student_id' });
  StudentModel.belongsToMany(ClassModel, { through: ClassStudentModel, foreignKey: 'student_id', otherKey: 'class_id' });
  ClassModel.belongsToMany(TeacherModel, { through: ClassTeacherModel, foreignKey: 'class_id', otherKey: 'teacher_id' });
  TeacherModel.belongsToMany(ClassModel, { through: ClassTeacherModel, foreignKey: 'teacher_id', otherKey: 'class_id' });
